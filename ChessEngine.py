...
class GameState:
    def __init__(self):
        # The board is an 8x8 square grid
        # 1 character represents the color (White= w / Black= b)
        # 2 character represents the piece of chess (Rook=R/Knight=N/Bishop=B/Queen=Q/King=K/Pawn=p)
        # "--" represents an empty space in the chess board
        self.board = [
